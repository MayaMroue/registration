...
const multiSelectVariants = cva(
  "m-1 transition ease-in-out delay-150  duration-300",
  {
    variants: {
      variant: {
        default: "border-black text-foreground bg-card hover:bg-card/80",
        secondary:
      ...
      >
        <PopoverTrigger asChild>
          <Button
            ...
            className={cn(
              "flex w-full p-1 text-black rounded-md border-2 min-h-10 h-auto items-center justify-between bg-inherit hover:bg-inherit",
              className
            )}
          >
              ...
              <div className="flex justify-between items-center w-full">
                <div className="flex flex-wrap items-center">
                  ...
                  {selectedValues.length > maxCount && (
                    <Badge
                      className={cn(
                        "bg-transparent text-foreground border-black hover:bg-transparent",
                        isAnimating ? "animate-bounce" : "",
                        multiSelectVariants({ variant })
                      )}
                      style={{ animationDuration: `${animation}s` }}
